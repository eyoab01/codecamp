...
1.copy the repository link from github.(https://github.com/eyoab01/codecamp
...
cd my-folder
git clone https://github.com/eyoab01/codecamp.git
...
go to your project folder and right click on the index.html or https://github.com/eyoab01/codecamp.git
...
- GitHub: [@hiwina](https://github.com/eyoab01/)
...
Feel free to check the [issues page](https://github.com/eyoab01/codecamp/issues).
...
- we would like to Thank my partners from microverse for supporting me to develop this application.
